...
def train_process(train_dataset_path = '/mnt/data4/Students/Lisha/patches_256/train_data_qp10.tfrecords', 
    val_dataset_path = '/mnt/data4/Students/Lisha/patches_256/validation_data_qp10.tfrecords', 
    lr = 0.001, ckpt_dir = '/mnt/data4/Students/Lisha/tf_ckpts/', name='MWCNN_m2', model_type = 'MWCNN', batch_size = 16, epochs = 70):
