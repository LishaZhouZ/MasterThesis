...
from utils_py3_tfrecord_256 import save_images
...
if __name__ == "__main__":
    ...
    restore_ckptPath = Path('/mnt/data4/Students/Lisha/tf_ckpts/MWCNN_MIDTERN/ckpt-15')
    mirror = 16
    ...
    for i in range(len(filepaths_label)):
        ...
        save_images(Path('/mnt/data4/Students/Lisha/outcome/MWCNN/' + str(i) +'.bmp'), img_s_label, noisy_image = img_s_input.numpy(), clean_image = np.squeeze(output_cut, axis=0))
