...
def train_process(train_dataset_path = '/mnt/data4/Students/Lisha/patches_80/train_data_q10.tfrecords', 
    val_dataset_path = '/mnt/data4/Students/Lisha/patches_80/validation_data_q10.tfrecords', 
    lr = 0.0001, ckpt_dir = '/mnt/data4/Students/Lisha/tf_ckpts/', name='AWNet-80', model_type = 'AWNet-80', batch_size = 32, epochs = 70):
