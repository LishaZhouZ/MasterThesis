...
from utils_py3_tfrecord_80 import save_images
...
if __name__ == "__main__":
    ...
    restore_ckptPath = Path('/mnt/data4/Students/Lisha/tf_ckpts/DnCNN_final_withonly10/ckpt-35')
    mirror = 4
    ...
    for i in range(len(filepaths_label)):
        ...
        save_images(Path('/mnt/data4/Students/Lisha/outcome/DnCNN/' + str(i) +'.bmp'), img_s_label, noisy_image = img_s_input.numpy(), clean_image = np.squeeze(output_cut, axis=0))
