...
def train_process(train_dataset_path = '/mnt/data4/Students/Lisha/patches/train_data_q10_128.tfrecords', 
    lr = 0.01, ckpt_dir = '/mnt/data4/Students/Lisha/tf_ckpts/', name='KaiNet_RGB_2', batch_size = 32, epochs = 50):
    ...
    decay_lr[30:40] = lr/100
    decay_lr[40:45] = lr/1000
    decay_lr[45:51] = lr/10000
    model = models.KaiNet_RGB()
