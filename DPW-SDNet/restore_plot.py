...
if __name__ == "__main__":
    ...
    for i in range(len(filepaths_label)):
        ...
        save_images(Path('/mnt/data4/Students/Lisha/outcome/DPW-SDNet/' + str(i) +'.bmp'), img_s_label, noisy_image = img_s_input.numpy(), clean_image = np.squeeze(output_cut, axis=0))
