...
if __name__ == "__main__":
    ...
    dir_input = Path('/mnt/data4/Students/Lisha/images/validation/live1_0-100/qp50')
    ...
    ckpt.restore(tf.train.latest_checkpoint('/mnt/data4/Students/Lisha/tf_ckpts/MWCNN_org')).expect_partial()
