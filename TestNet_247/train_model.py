...
def train_one_epoch(model, dataset, optimizer, logdir, ckpt, manager, record_step):
    org_psnr = PSNRMetric()
    opt_psnr = PSNRMetric()
    ...
    for images, labels in dataset.take(800):
        ...
        if int(step) % record_step == 0:
            ...
            with train_writer.as_default():
                ...
                tf.summary.scalar('RGB_loss', rgb_loss.result(), step = step)
