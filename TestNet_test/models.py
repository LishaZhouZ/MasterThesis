...
class TestNet_LH(tf.keras.Model):
    def __init__(self):
        super(TestNet_LH, self).__init__()
        self.my_initial = tf.initializers.he_uniform()
...
class TestNet_HL(tf.keras.Model):
    def __init__(self):
        super(TestNet_HL, self).__init__()
        self.my_initial = tf.initializers.he_uniform()
...
class TestNet_HH(tf.keras.Model):
    def __init__(self):
        super(TestNet_HH, self).__init__()
        self.my_initial = tf.initializers.he_uniform()
